...
import { Badge, Button, Card, Container, Dropdown, Table } from "react-bootstrap";
...
export default function Invigilator() {
  ...
  const getAllInvigilators = async () => {
    await InvigilatorService.getAllInvigilators().then((res) => {
      if (res.status === 200) {
                          ...
                          <td>
                            <Dropdown>
                              ...
                              <Dropdown.Menu>
                                ...
                                <Dropdown.Divider />
                                <Dropdown.Item
                                // onClick={() => deleteInvigilator(data._id)}
                                >
